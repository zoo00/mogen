...
device = torch.device("cuda:11" if cuda_condition else "cpu")
...
if dataset == 'GDSC':
    Gene_expression_file = '/home/zoo00/GEN/data/GDSCdata/GDSC_Methylation_illumina450k.csv'
...
save_path = '/home/zoo00/GEN/methylation/weights/'
img_path = '/home/zoo00/GEN/methylation/results/'
result_path = '/home/zoo00/GEN/methylation/imgs/'
